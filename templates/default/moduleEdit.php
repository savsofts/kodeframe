...
<div class="row">
	...
	<h2>Edit record | <?php echo $table_data[0]['module_name'];?></h2>
		<?php 
 ...
 if($col_types[$k]=="varchar(1000)"){
	 ?>
	<input type="text" name="<?php echo $col_name;?>" value="<?php echo $result['0'][$col_name]; ?>" class="form-control formula_val <?php echo $col_name;?>" > 
...
<input type="hidden" id="b64_<?php echo $col_name;?>" name="<?php echo $col_name;?>" value="<?php echo $result['0'][$col_name];?>"> 
<span style='color:red' id='ierror_<?php echo $col_name;?>'></span>
<img id="img_<?php echo $col_name;?>" class='img-responsive' src="<?php echo $result['0'][$col_name];?>" >
...
document.getElementById("inp_<?php echo $col_name;?>").addEventListener("change", function() {
 ...
 if($col_types[$k]=="password"){
	 ?>
	<input type="password" name="<?php echo $col_name;?>" value="" class="form-control formula_val <?php echo $col_name;?>" > 
	 
	 <?php 
 } 
 if($col_types[$k]=="date"){
	 ?>
	<input type="date" name="<?php echo $col_name;?>" value="<?php echo $result['0'][$col_name]; ?>" class="form-control formula_val <?php echo $col_name;?>" > 
	 
	 <?php 
 }
	 if($col_types[$k]=="int(11)"){
	 ?>
	<input type="number" name="<?php echo $col_name;?>" value="<?php echo $result['0'][$col_name]; ?>" class="form-control formula_val <?php echo $col_name;?>" > 
	 <?php 
 }	 
...
if($col_types[$k]=="text"){
	 ?>
	<textarea name="<?php echo $col_name;?>"  class="form-control formula_val <?php echo $col_name;?>" ><?php echo $result['0'][$col_name]; ?></textarea>
	 <?php 
 }
if($col_types[$k]=="enum"){
	 ?>
	...
	foreach(explode(':',$col_values[$k]) as $sk =>$sv){
		?>
	<option value="<?php echo $sv;?>" <?php if($result['0'][$col_name]==$sv){ echo 'selected';} ?> ><?php echo $sv;?></option>	
		<?php 
	}
	?>
	</select>
 ...
 if($col_types[$k]=="formula"){
	 ?>
	<input type="text" name="<?php echo $col_name;?>" data-formula="<?php echo $col_values[$k];?>" id="<?php echo $col_name;?>" value="<?php echo $result['0'][$col_name]; ?>" class="form-control" readonly=readonly > 
...
formula[fi]="<?php echo $col_name;?>";
 ...
 ?>
  <?php 
	 ...
	 ?>
	 <select name="<?php echo $col_name;?>"  class="form-control" >
	 <?php 
	 foreach($joins_result[$col_name] as $jk => $jval){
		?>
	<option value="<?php echo $jval[$col_name];?>" <?php if($result['0'][$col_name]==$jval[$col_name]){ echo 'selected'; } ?> ><?php echo $jval[$col_name];?></option>	
		<?php 		 
	 }
	 ?>
	 </select>
